...
graphics_loader
    ...
    .add("undyne_breastplate", "img/TUSB_breastplate.png")
    ...
    .add("undyne_head1", "img/TUSB_head2.png")
    .add("undyne_head2", "img/TUSB_head2.png")
    .add("undyne_head3", "img/TUSB_head2.png")
    .add("undyne_head4", "img/TUSB_head2.png")
    .add("undyne_intro_hairless", "img/TUSB_intro_hairless.png")
    .add("undyne_leftarm", "img/undyne_leftarm.png")
    .add("undyne_legs", "img/undyne_legs.png")
    .add("undyne_rightarm", "img/undyne_rightarm.png")
    .add("undyne_skirt", "img/TUSB_skirt.png")
